        ...
        VStack(spacing: 0) {
            ...
            VStack {
                ...
                Text("Passa a Premium")
                    ...
                    .padding(.top, 2)
                Text("Sblocca tutto il potenziale di Personal Best Running")
                    .font(.subheadline)
            ...
            Button {
                ...
                .background(
                    LinearGradient(
                        colors: storeKitManager.premiumLocalizedPrice != nil && !storeKitManager.isPurchasing
                            ? [
            ...
            .disabled(storeKitManager.isPurchasing || storeKitManager.premiumLocalizedPrice == nil)
            .padding(.horizontal, 20)
            .padding(.top, 15.0)
